...
public class Workshop {
    ...
    for(int a=0; a<arreglo.length; a++){
        invertido[a] = arreglo[arreglo.length - 1 - a];
    }
 ...
 int[] temporal = new int[arreglo.length];
    ...
    for(int a=0; a<arreglo1.length; a++){
        resultado[a] = arreglo1[a];
    }

    for(int a=0; a<arreglo2.length; a++){
        resultado[arreglo1.length + a] = arreglo2[a];
    }
    ...
    for(int a=0; a<arreglo.length; a++){
        ...
        resultado[nuevaPosicion] = arreglo[a];
    }
    ...
    public int contarCaracteres(String cadena) {
	    ...
	    return cadena.length();//El test espera que el codigo devuelva el numero 13 para "Hola mundo", pero tiene 10 caracteres. También espera 14 para "Hola mundo", pero tiene 12. El error está en los valores del test.
    }
    ...
    for(int a=0; a<=cadena.length()-subcadena.length(); a++){
        int b=0;

        while(b<subcadena.length() && cadena.charAt(a+b)==subcadena.charAt(b)){
            b++;
        }

        if(b==subcadena.length()){
            return a;
        }
    }
...
Rock crushes Scissors
    ...
    if((game[0].equals("R") && (game[1].equals("S") || game[1].equals("L"))) ||
       (game[0].equals("P") && (game[1].equals("R") || game[1].equals("V"))) ||
       (game[0].equals("S") && (game[1].equals("P") || game[1].equals("L"))) ||
       (game[0].equals("L") && (game[1].equals("V") || game[1].equals("P"))) ||
       (game[0].equals("V") && (game[1].equals("S") || game[1].equals("R")))){
        return "Player 1";
    }
